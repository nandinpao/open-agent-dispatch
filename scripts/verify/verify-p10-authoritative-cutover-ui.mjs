...
const files = [
  ...
  'ai-event-gateway-admin-ui/components/dispatch-governance/CutoverPanel.tsx',
...
console.log(`[PASS] P10 authoritative cutover TypeScript/TSX syntax transpile (${files.length} files).`);
