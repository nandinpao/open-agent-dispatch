...
grep -R -q 'classpath:db/migration' ai-event-gateway-core-app/src/main/resources

test -f ai-event-gateway-core-app/src/test/java/com/opensocket/aievent/core/architecture/P1DatabaseMigrationConsolidationTest.java
