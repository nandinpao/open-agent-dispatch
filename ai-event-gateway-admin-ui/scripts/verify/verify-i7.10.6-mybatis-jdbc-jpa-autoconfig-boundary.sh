...
APP_POM="ai-event-gateway-core-app/pom.xml"
DB_POM="ai-event-gateway-database-platform/pom.xml"
...
app_scopes = find_dependencies("ai-event-gateway-core-app/pom.xml", "spring-jdbc")
db_scopes = find_dependencies("ai-event-gateway-database-platform/pom.xml", "spring-jdbc")
if not app_scopes:
