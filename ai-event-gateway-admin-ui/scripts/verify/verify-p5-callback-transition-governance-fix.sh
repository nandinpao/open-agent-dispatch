...
root = Path('.')
service = (root / 'ai-event-gateway-core-execution-control/src/main/java/com/opensocket/aievent/core/callback/TaskCallbackService.java').read_text()
...
p2_test = (root / 'ai-event-gateway-core-app/src/test/java/com/opensocket/aievent/core/architecture/P2DatabaseDaoPoConsolidationTest.java').read_text()
