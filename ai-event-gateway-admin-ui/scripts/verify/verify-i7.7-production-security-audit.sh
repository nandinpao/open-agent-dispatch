...
CORE_PROD="$ROOT_DIR/ai-event-gateway-core-app/src/main/resources/application-prod.yml"
VALIDATOR="$ROOT_DIR/ai-event-gateway-core-app/src/main/java/com/opensocket/aievent/core/config/CoreDeploymentModeValidator.java"
