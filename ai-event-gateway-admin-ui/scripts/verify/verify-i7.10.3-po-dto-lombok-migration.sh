...
DB_PLATFORM="$ROOT/ai-event-gateway-database-platform/src/main/java"
...
for dto in \
  "$ROOT/ai-event-gateway-core-data-model/src/main/java/com/opensocket/aievent/core/event/EventIntakeRequest.java" \
  "$ROOT/ai-event-gateway-core-contracts/src/main/java/com/opensocket/aievent/core/callback/TaskCallbackRequest.java" \
  "$ROOT/ai-event-gateway-core-contracts/src/main/java/com/opensocket/aievent/core/api/ApiErrorResponse.java" \
  "$ROOT/ai-event-gateway-core-contracts/src/main/java/com/opensocket/aievent/core/dispatch/GatewayDispatchResponse.java" \
  "$ROOT/ai-event-gateway-core-data-model/src/main/java/com/opensocket/aievent/core/action/executor/mcp/McpExecutorRequest.java" \
  "$ROOT/ai-event-gateway-core-data-model/src/main/java/com/opensocket/aievent/core/action/executor/mcp/McpExecutorResponse.java" \
  "$ROOT/ai-event-gateway-core-data-model/src/main/java/com/opensocket/aievent/core/action/executor/issue/IssueExecutorRequest.java" \
  "$ROOT/ai-event-gateway-core-data-model/src/main/java/com/opensocket/aievent/core/action/executor/issue/IssueExecutorResponse.java"; do
...
grep -q 'new LinkedHashMap<>(payload)' "$ROOT/ai-event-gateway-core-contracts/src/main/java/com/opensocket/aievent/core/callback/TaskCallbackRequest.java" \
  || fail "TaskCallbackRequest must preserve defensive payload copy."
grep -q 'new LinkedHashMap<>(payload)' "$ROOT/ai-event-gateway-core-data-model/src/main/java/com/opensocket/aievent/core/action/executor/mcp/McpExecutorRequest.java" \
  || fail "McpExecutorRequest must preserve defensive payload copy."
grep -q 'new LinkedHashMap<>(payload)' "$ROOT/ai-event-gateway-core-data-model/src/main/java/com/opensocket/aievent/core/action/executor/issue/IssueExecutorRequest.java" \
...
DOMAIN_DIRS=(
  "$ROOT/ai-event-gateway-core-execution-control/src/main/java"
  "$ROOT/ai-event-gateway-core-task-orchestration/src/main/java"
  "$ROOT/ai-event-gateway-core-agent-control/src/main/java"
)
