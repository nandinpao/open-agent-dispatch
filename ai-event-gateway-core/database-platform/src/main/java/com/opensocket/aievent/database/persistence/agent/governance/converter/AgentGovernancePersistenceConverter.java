...
public class AgentGovernancePersistenceConverter {
    ...
    public AgentProfilePo toPo(AgentProfile item) {
        ...
        po.setOwnerDepartmentId(item.getOwnerDepartmentId());
        po.setOwnerGroupId(item.getOwnerGroupId());
        po.setBusinessOwnerUserId(item.getBusinessOwnerUserId());
        po.setTechnicalStewardUserId(item.getTechnicalStewardUserId());
        po.setResponsibilityRoleId(item.getResponsibilityRoleId());
        po.setResponsibilityBindingId(item.getResponsibilityBindingId());
        po.setOwnershipReviewStatus(item.getOwnershipReviewStatus());
        po.setOwnershipReviewReason(item.getOwnershipReviewReason());
        po.setNextOwnershipReviewAt(item.getNextOwnershipReviewAt());
        po.setServiceDomainId(item.getServiceDomainId());
        po.setTrustZoneId(item.getTrustZoneId());
    ...
    public AgentProfile toProfile(AgentProfilePo po) {
        ...
        item.setOwnerDepartmentId(po.getOwnerDepartmentId());
        item.setOwnerGroupId(po.getOwnerGroupId());
        item.setBusinessOwnerUserId(po.getBusinessOwnerUserId());
        item.setTechnicalStewardUserId(po.getTechnicalStewardUserId());
        item.setResponsibilityRoleId(po.getResponsibilityRoleId());
        item.setResponsibilityBindingId(po.getResponsibilityBindingId());
        item.setOwnershipReviewStatus(po.getOwnershipReviewStatus());
        item.setOwnershipReviewReason(po.getOwnershipReviewReason());
        item.setNextOwnershipReviewAt(po.getNextOwnershipReviewAt());
        item.setServiceDomainId(po.getServiceDomainId());
        item.setTrustZoneId(po.getTrustZoneId());
