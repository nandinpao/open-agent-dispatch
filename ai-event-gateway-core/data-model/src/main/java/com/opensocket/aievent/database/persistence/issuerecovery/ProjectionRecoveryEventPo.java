...
public class ProjectionRecoveryEventPo {
 ...
 public String getAggregateType(){return aggregateType;} public void setAggregateType(String value){this.aggregateType=value;}
