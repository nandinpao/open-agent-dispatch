...
LOCAL_YML="$ROOT_DIR/control-plane-app/src/main/resources/application-local.yml"
DEV_YML="$ROOT_DIR/control-plane-app/src/main/resources/application-dev.yml"
