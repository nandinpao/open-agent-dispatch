...
REQ="$ROOT_DIR/data-model/src/main/java/com/opensocket/aievent/core/event/EventIntakeRequest.java"
TEST_CFG="$ROOT_DIR/control-plane-app/src/test/resources/application-test.yml"
if [[ ! -f "$REQ" ]]; then
