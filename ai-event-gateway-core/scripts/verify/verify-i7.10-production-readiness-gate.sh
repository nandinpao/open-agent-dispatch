...
APP_PROD="control-plane-app/src/main/resources/application-prod.yml"
APP_COMMON="control-plane-app/src/main/resources/application.yml"
VALIDATOR="control-plane-app/src/main/java/com/opensocket/aievent/core/config/CoreDeploymentModeValidator.java"
MOCK_MCP="adapter-action/src/main/java/com/opensocket/aievent/core/action/executor/MockMcpActionExecutor.java"
...
if grep -R "matchIfMissing = true" adapter-action/src/main/java/com/opensocket/aievent/core/action/executor \
