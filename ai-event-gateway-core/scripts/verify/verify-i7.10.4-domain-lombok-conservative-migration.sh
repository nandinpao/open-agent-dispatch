...
for f in \
  "data-model/src/main/java/com/opensocket/aievent/core/incident/Incident.java" \
  "data-model/src/main/java/com/opensocket/aievent/core/summary/IncidentOccurrenceSummary.java" \
  "data-model/src/main/java/com/opensocket/aievent/core/decision/EventDecisionRecord.java" \
  "data-model/src/main/java/com/opensocket/aievent/core/dedup/DedupState.java" \
  "data-model/src/main/java/com/opensocket/aievent/core/gateway/GatewayNode.java" \
  "data-model/src/main/java/com/opensocket/aievent/core/agent/AgentSnapshot.java" \
  "data-model/src/main/java/com/opensocket/aievent/core/integration/IntegrationEventRecord.java" \
  "data-model/src/main/java/com/opensocket/aievent/core/outbox/OutboxEventRecord.java"; do
  require_file "$f"
...
for dir in \
  "execution-control/src/main/java/com/opensocket/aievent/core/dispatch" \
  "execution-control/src/main/java/com/opensocket/aievent/core/callback" \
  "task-orchestration/src/main/java/com/opensocket/aievent/core/task" \
  "task-orchestration/src/main/java/com/opensocket/aievent/core/assignment"; do
  [[ -d "$ROOT/$dir" ]] || continue
