...
public final class InboundEventClassifier {
    ...
    public static InboundEventCategory classify(MessageType messageType) {
        ...
        return switch (messageType) {
            case TASK_RESULT, TASK_ERROR, A2A_REQUEST -> InboundEventCategory.BUSINESS_EVENT;
            case TASK_DISPATCH, TASK_CANCEL, TASK_ACK, TASK_PROGRESS -> InboundEventCategory.TASK_LIFECYCLE_EVENT;
            ...
            case TASK_SUBMIT, CAPABILITY_DELEGATION_RESULT, ADMIN_EVENT, GATEWAY_ACK, ERROR -> InboundEventCategory.SYSTEM_SIGNAL;
        };
    }
}
